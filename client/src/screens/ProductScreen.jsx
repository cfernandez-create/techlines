...
const ProductScreen = () => {
  ...
  const changeAmount = (input) => (input === "plus" ? setAmount(amount + 1) : setAmount(amount - 1));
    ...
    <Wrap spacing="30px" justify="center" minHeight="100vh">
      {loading ? (
        <Stack direction="row" spacing={4}>
          <Spinner mt={20} thickness="2px" speed="0.65" emptyColor="gray.200" color="orange.500" size="xl" />
        </Stack>
      ) : error ? (
        <Alert status="error">
          <AlertIcon />
            ...
            <Stack direction={{ base: "column", lg: "row" }} align={{ lg: "flex-start" }}>
              ...
              >
                ...
                <Stack spacing="5">
                  ...
                  <Button isDisabled={product.stock === 0} colorScheme="orange" maxW="170px" onClick={() => addItem()}>
                    Add to cart
                  </Button>
                  <Stack w="270px">
